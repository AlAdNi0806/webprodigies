...
const HomePage = () => {
  return (
    <>
        <section className='overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center items-center'>
          <TitleSection 
        ...
        <section className='px-4 sm:px-6 flex justify-center items-center flex-col relative'>
          ...
          <TitleSection
            ...
            pill="Features"
          />
          <div className='mt-10 max-w-[450px] flex justify-center items-center relative sm:ml-0 rounded-3xl border-8 border-washed-purple-300 border-opacity-10 overflow-hidden'>
          ...
          <div className='flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10'>
            {PRICING_CARDS.map((card) => (
              <CustomCard 
                key={card.planType}
                className={clsx(
                    'w-[350px] rouded-2xl dark:bg-black/40 background-blur-3xl relative',
                    {
